...
test.describe('Main window web content', async () => {
  ...
  test('The main window has an interactive button', async () => {
    {
  ...
  test('The main window has header with avatar name', async () => {
    // ヘッダーが表示されていることを確認
  ...
  test('The main window has input panel with text input', async () => {
    // 入力パネルが表示されていることを確認
  ...
  test('The main window has menu button in header', async () => {
    // ヘッダーのメニューボタンが表示されていることを確認
    const menuButton = page.locator('aside.q-drawer i.q-icon',{hasText: 'face'});
    await expect(menuButton).toBeVisible();
  });

  test('The main window has volume control button', async () => {
    // 音量制御ボタンが表示されていることを確認
    const volumeButton = page.locator('div.q-bar button.q-btn',{hasText: 'volume_up'});
    await expect(volumeButton).toBeVisible();
  });

  test('The main window has chat toggle button in footer', async () => {
    // フッターのチャットトグルボタンが表示されていることを確認
    const chatButton = page.locator('footer.q-footer button.q-btn',{hasText: 'chat'});
    await expect(chatButton).toBeVisible();
  });

  // test('The main window has main image display area', async () => {
  ...
  test('The main window has file upload button', async () => {
    // ファイルアップロードボタンが表示されていることを確認
    const fileUpload = page.locator('.q-file');
    await expect(fileUpload).toBeVisible();

    // ファイルアップロードのアイコンが表示されていることを確認
    const fileIcon = page.locator('.q-file i.q-icon',{hasText: 'attach_file'});
    await expect(fileIcon).toBeVisible();
  });

  test('The main window has MCP resource button', async () => {
    // MCPリソースボタンが表示されていることを確認
    const mcpButton = page.locator('button.q-btn',{hasText: 'text_snippet'});
    await expect(mcpButton).toBeVisible();
  });

  test('The main window has window control buttons', async () => {
    // ウィンドウ制御ボタンが表示されていることを確認
    const minimizeButton = page.locator('div.q-bar button.q-btn',{hasText: 'minimize'});
    const maximizeButton = page.locator('div.q-bar button.q-btn',{hasText: 'crop_square'});
    const closeButton = page.locator('div.q-bar button.q-btn',{hasText: 'close'});
  ...
  test('The main window has search button in header', async () => {
    // 検索ボタンが表示されていることを確認
    const searchButton = page.locator('div.q-bar button.q-btn',{hasText: 'search'});
    await expect(searchButton).toBeVisible();
  });

  test('The main window has connection status button', async () => {
    // 接続状態ボタンが表示されていることを確認
    const connectionButton = page.locator('div.q-bar button.q-btn',{hasText: 'wifi'});
    await expect(connectionButton).toBeVisible();
  });

  test('The main window has schedule button in header', async () => {
    // スケジュールボタンが表示されていることを確認
    const scheduleButton = page.locator('div.q-bar button.q-btn',{hasText: 'schedule'});
    await expect(scheduleButton).toBeVisible();
  });

  // test('Input panel is disabled initially', async () => {
  //   // 初期状態で入力パネルが無効化されていることを確認
  //   const textInput = page.locator('q-input input[type="text"]');
  //   const sendButton = page.locator('q-btn',{hasText: 'send'});
  //   const fileUpload = page.locator('q-file');
  //
  ...
  test('The main window has proper layout structure', async () => {
  ...
  test('The main window has wave background animation', async () => {
  ...
  test('Menu drawer can be toggled', async () => {
    // メニューボタンをクリックしてドロワーを開く
    const menuButton = page.locator('footer.q-footer button.q-btn',{hasText: 'menu'});
    await menuButton.click();

    // ドロワーが表示されることを確認
    const drawer = page.locator('aside.q-drawer--left');
  ...
  test('Chat drawer can be toggled', async () => {
    // チャットボタンをクリックしてドロワーを開く
    const chatButton = page.locator('footer.q-footer button.q-btn',{hasText: 'chat'});
    await chatButton.click();

    // 右側のドロワーが表示されることを確認
    const rightDrawer = page.locator('aside.q-drawer--right');
  ...
  test('Volume control popup can be opened', async () => {
    // 音量ボタンをクリックしてポップアップを開く
    const volumeButton = page.locator('div.q-bar button.q-btn',{hasText: 'volume'});
    await volumeButton.click();

    // 音量制御パネルが表示されることを確認
    const volumePanel = page.locator('div.q-menu');
    await expect(volumePanel).toBeVisible();
  });

  test('Search button opens image selector', async () => {
    // 検索ボタンをクリックして画像セレクターを開く
    const searchButton = page.locator('div.q-bar button.q-btn',{hasText: 'search'});
    await searchButton.click();

    // 画像セレクターが表示されることを確認
    const imageSelector = page.getByTestId('image-selector');
  ...
  test('Text input accepts user input', async () => {
    // テキスト入力フィールドにテキストを入力
    const textInput = page.getByRole('textbox',{name:'talk input'}) //.locator('div.q-input input[type="text"]');
  ...
  test('MCP resource button shows menu', async () => {
  ...
  test('Window control buttons are clickable', async () => {
  ...
  test('Connection status button toggles state', async () => {
    // 接続状態ボタンをクリック
    const connectionButton = page.locator('div.q-bar button.q-btn',{hasText: 'wifi'});
  ...
  test('Schedule button toggles state', async () => {
    // スケジュールボタンをクリック
    const scheduleButton = page.locator('div.q-bar button.q-btn',{hasText: 'schedule'});
  ...
  test('Main image has popup on click', async () => {
    // メイン画像をクリック
    const mainImage = page.locator('div.q-img');
    await mainImage.click();

    // ポップアップが表示されることを確認
    const popup = page.locator('div.q-menu');
    await expect(popup).toBeVisible();
  });

  test('Application has proper accessibility attributes', async () => {
    // アクセシビリティ属性が適切に設定されていることを確認
    const textInput = page.getByRole('textbox',{name:'talk input'})
    const sendButton = page.locator('button.q-btn',{hasText: 'send'});
    const fileUpload = page.locator('.q-file i.q-icon',{hasText: 'attach_file'});
  ...
  test('Application handles different screen sizes', async () => {
    // 異なる画面サイズでの表示をテスト
  ...
  test('Application has proper keyboard navigation', async () => {
...
/*
  test('Application shows loading states appropriately', async () => {
  ...
  test('Application handles error states gracefully', async () => {
    // エラー状態が適切に処理されることを確認
    const mainImage = page.locator('div.q-img');
