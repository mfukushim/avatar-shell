...
// export const AsClassWithUndefined = Schema.transform(
//   // Source schema: "on" or "off"
//   AsClassBaseSchema,
//   // Target schema: boolean
//   Schema.UndefinedOr(AsClassSchema),
//   {
...
//     // target schema (boolean)
//     decode: (literal) => literal || undefined, // Always succeeds here
...
// export interface ExternalAutoUserSettings extends ContextGeneratorSetting {
//   externalGenerator: string
// }
//
// export const cGSettings = [
//   ['PixAi',{} as PixAiSettings]
// ]
